...
-- larger applications providing that a translation from the update/state/event
-- types of the inner application to the outer application (this translation
-- is called a `focus`, as the subapplication can be seen as a `focus` on one
-- particular part of the wider state.).
delegate
